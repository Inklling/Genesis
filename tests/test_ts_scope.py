...
class TestUnusedVariables:
    ...
    def test_assigned_but_never_used(self):
        ...
        from wiz.ts_scope import check_unused_variables
        code = """\
def f():
    x = 42
    return None
...
class TestVariableShadowing:
    ...
    def test_inner_function_shadows_outer(self):
        ...
        from wiz.ts_scope import check_variable_shadowing
        code = """\
def outer():
    x = 10
    def inner():
...
class TestUninitializedVariables:
    ...
    def test_used_before_assignment(self):
        ...
        from wiz.ts_scope import check_uninitialized_variables
        code = """\
def f():
    y = x + 1
    x = 10
